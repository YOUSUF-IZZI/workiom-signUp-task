    ...
    return GestureDetector(
          ...
          return CupertinoActionSheet(
            actions: [
              CupertinoActionSheetAction(
                  onPressed: (){
                    ref.read(currentLanguageProvider.notifier).state = 'English';
              ...
              CupertinoActionSheetAction(
                  onPressed: (){
                    ref.read(currentLanguageProvider.notifier).state = 'العربية';
                    Navigator.pop(context);
                  },
              ...
              CupertinoActionSheetAction(
                  onPressed: (){
                    ref.read(currentLanguageProvider.notifier).state = 'Türkçe';
                    Navigator.pop(context);
                  },
      ...
      child: Row(
        ...
        children: [
          ...
          SizedBox(width: 8.w,),
          Text(ref.watch(currentLanguageProvider)),
          SizedBox(width: 8.w,),
